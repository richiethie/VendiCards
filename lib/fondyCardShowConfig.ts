...
export const fondyCardShow = {
  ...
  dateDisplay: 'Sunday, October 25th',

  /** Used in metadata and long-form copy */

  dateDisplayLong: 'Sunday, October 25, 2026',

  monthYearLabel: 'October 2026',



  /** Home page announcement ticker (keep short for mobile) */

  announcementBannerText: 'FONDY CARD SHOW — OCTOBER 25',
  ...
  startDateTime: '2026-10-25T09:00:00-05:00',

  endDateTime: '2026-10-25T16:00:00-05:00',
  ...
  vendorBookingUrl:
    ...
    'https://app.joinshowup.io/apply/the-fondy-card-show-hosted-by-vendicards-october25th-789070818',
   ...
   * September 16, 2026 8:00 AM CDT = 13:00 UTC.

   */

  vendorSignupGoLiveUtc: '2026-09-16T13:00:00.000Z',

  vendorSignupGoLiveDisplay: '8:00 AM CT on September 16, 2026',



  /** Event poster under /public/images */

  posterSrc: '/images/fondy-card-show-october-2026.png',

  posterAlt:

    'Fondy Card Show Event Poster - Sunday October 25th, 2026 at Radisson Hotel Fond du Lac - Trading Cards & Collectibles',
